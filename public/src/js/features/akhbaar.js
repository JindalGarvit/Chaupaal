...
async function buildAkhbaar(QUESTIONS_IN,BONUS_QUESTIONS_IN){
  ...
  rc.innerHTML=`
    <div class="results-brand"><span class="cp-mark cp-mark--sm" aria-hidden="true"><img src="/brand/chaupaal-mark-charpai.png" alt="" width="20" height="20"></span> Chaupaal — Aaj ka Akhbaar<span class="results-date" id="resultsDate"></span></div>
