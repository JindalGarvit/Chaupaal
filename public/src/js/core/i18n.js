...
const I18N = {
  en:{
    ...
    display_mode_auto_desc:'Matches local time and weather',
    display_mode_light:'Light',
    display_mode_light_desc:'Bright, steady look',
    display_mode_dark:'Dark',
    display_mode_dark_desc:'Neutral dark interface',
    display_mode_night:'Night',
    display_mode_night_desc:'Dim and warm for late hours',
    display_ambient_label:'Ambient sound',
    display_ambient_desc:'Soft background tone in Auto mode (off by default)',
    display_geo_enable:'Enable location for weather look',
    display_geo_status_unknown:'Location for weather look: not set (uses clock and city if available)',
    display_geo_status_granted:'Location for weather look: on (never shared with anyone)',
    display_geo_status_denied:'Location for weather look: off — enable in browser settings, then tap below',
    display_geo_prompt_title:'Match Chaupaal to your sky?',
    display_geo_prompt_body:'Chaupaal can match the app’s look and feel to your local time and weather. Your location is never shared with anyone.',
  ...
  hi:{
    ...
    settings_display:'Display & sound',
    display_mode_auto:'Auto',
    display_mode_auto_desc:'Local time aur mausam ke saath',
    display_mode_light:'Light',
    display_mode_light_desc:'Bright, stable look',
    display_mode_dark:'Dark',
    display_mode_dark_desc:'Neutral dark interface',
    display_mode_night:'Night',
    display_mode_night_desc:'Raat ke liye dim aur warm',
    display_ambient_label:'Ambient sound',
    display_ambient_desc:'Auto mode mein soft background (default off)',
    display_geo_enable:'Mausam look ke liye location on karein',
    display_geo_status_unknown:'Mausam look location: set nahi (clock / city use hogi)',
    display_geo_status_granted:'Mausam look location: on (kisi se share nahi)',
    display_geo_status_denied:'Mausam look location: off — browser settings mein enable karein',
    display_geo_prompt_title:'Chaupaal aasman se match kare?',
    display_geo_prompt_body:'Chaupaal aapke local time aur mausam ke hisaab se look badal sakta hai. Location kisi se share nahi hoti.',
    display_geo_prompt_allow:'Continue',
  ...
  ta:{
    ...
    settings_display:'Display & sound',
    display_mode_auto:'Auto',
    display_mode_auto_desc:'Local time matrum weather-udan',
    display_mode_light:'Light',
    display_mode_light_desc:'Bright, steady look',
    display_mode_dark:'Dark',
    display_mode_dark_desc:'Neutral dark interface',
    display_mode_night:'Night',
    display_mode_night_desc:'Iravil dim matrum warm',
    display_ambient_label:'Ambient sound',
    display_ambient_desc:'Auto mode-il soft background (default off)',
    display_geo_enable:'Weather look-kaga location on seyyungal',
    display_geo_status_unknown:'Weather look location: set illai (clock / city)',
    display_geo_status_granted:'Weather look location: on (yaarumum share seyyappadathu)',
    display_geo_status_denied:'Weather look location: off — browser settings-il enable seyyungal',
    display_geo_prompt_title:'Chaupaal vaanathudan match aaga?',
    display_geo_prompt_body:'Chaupaal ungallocal time matrum weather-in padi look maaraalam. Location yaarumum share seyyappadathu.',
    display_geo_prompt_allow:'Continue',
