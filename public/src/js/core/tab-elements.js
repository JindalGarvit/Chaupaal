...
(function () {
  ...
  const SHORTCUT_SVGS = {
    ...
    hidden: `<svg viewBox="0 0 24 24" class="tab-sc-svg" aria-hidden="true"><rect x="5" y="10" width="14" height="10" rx="2.5" fill="#C47A3A"/><path d="M8 10V8a4 4 0 0 1 8 0v2" fill="none" stroke="#8B5A2B" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="15" r="1.4" fill="#F6E7D0"/></svg>`,
    ...
    safar: `<svg viewBox="0 0 24 24" class="tab-sc-svg" aria-hidden="true"><path d="M5 18c2-4 4.5-6.5 7-6.5s5 2.5 7 6.5" fill="none" stroke="#C77DFF" stroke-width="1.8" stroke-linecap="round"/><path d="M7 14c1.5-2.5 3-4 5-4s3.5 1.5 5 4" fill="none" stroke="#9B5DE5" stroke-width="1.4" stroke-linecap="round"/><circle cx="12" cy="7" r="2.4" fill="#EDE4FF" stroke="#7B2CBF" stroke-width="1"/><circle cx="12" cy="7" r="1.1" fill="#7B2CBF"/></svg>`,
