...
(function () {
  ...
  const SHORTCUT_SVGS = {
    ...
    // Dangal (fire)
    pulse: `<svg viewBox="0 0 24 24" class="tab-sc-svg" aria-hidden="true"><path d="M3 12h4l2-5 3 10 2-5h7" fill="none" stroke="#E85D04" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
