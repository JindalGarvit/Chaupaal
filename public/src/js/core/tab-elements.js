...
(function () {
  ...
  const SHORTCUT_SVGS = {
    ...
    find: `<svg viewBox="0 0 24 24" class="tab-sc-svg" aria-hidden="true"><circle cx="9" cy="9" r="3.2" fill="#4CAF50"/><circle cx="15.5" cy="9.5" r="2.8" fill="#81C784"/><path d="M4.5 18c1.2-2.4 3-3.6 4.5-3.6S12.3 15.6 13.5 18M13 18c.8-1.6 2-2.4 3-2.4s2 .7 2.8 2" fill="none" stroke="#1B6B2F" stroke-width="1.6" stroke-linecap="round"/></svg>`,
    // Akhbaar (air)
    ...
    safar: `<svg viewBox="0 0 24 24" class="tab-sc-svg" aria-hidden="true"><defs><linearGradient id="scSafar" x1="4" y1="4" x2="20" y2="20"><stop stop-color="#FFD166"/><stop offset="1" stop-color="#7B2CBF"/></linearGradient></defs><path d="M4 17c3-6 6-9 8-9s5 3 8 9" fill="none" stroke="url(#scSafar)" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="7" r="2.4" fill="#FFC93C"/><path d="M8 14h8" stroke="#9B5DE5" stroke-width="1.3" stroke-linecap="round" opacity=".7"/></svg>`,
