  ...
  if(attachment && typeof attachment==='object' && attachment.type){
    if(attachment.type==='location' && typeof normalizeLocationAttachment==='function'){
      ...
      payload.attachment={
        ...
        timeMin:attachment.timeMin!=null?(Number(attachment.timeMin)||0):null,
        timeInc:attachment.timeInc!=null?(Number(attachment.timeInc)||0):null,
        chess960:attachment.chess960===true?true:(attachment.chess960===false?false:null),
